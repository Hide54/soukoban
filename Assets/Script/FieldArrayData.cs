...
public class FieldArrayData : MonoBehaviour
{
    ...
    [Header("ゴールオブジェクトを設定(Tagを識別する)")]
    [SerializeField] GameObject g_goal;
    [Header("歩数を表示するオブジェクトを設定")]
    [SerializeField] Text text_Step;
    [Header("最小歩数を表示するオブジェクトを設定")]
    [SerializeField] Text text_Step_min;
